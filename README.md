...
Sistem manajemen restoran berbasis GUI yang dibangun menggunakan bahasa Java. Proyek ini menerapkan konsep Object-Oriented Programming (OOP) seperti Inheritance, Polymorphism, Encapsulation, dan Abstraction.

Sistem ini menggunakan File I/O (file .txt) sebagai database sederhana untuk menyimpan data menu, pegawai, dan customer.
...
💁 Pelayan (Waiter)
Update Status: Membantu membuat pesanan

💸 Kasir
Proses Pembayaran: Melihat pesanan yang siap dibayar dan memproses transaksi (Cash/Non-Cash).

Cetak Struk: Mencetak rincian transaksi ke layar setelah pembayaran berhasil.

🛠️ Teknologi yang Digunakan
Bahasa: Java (JDK 8 atau terbaru).
