...
Sistem manajemen restoran berbasis GUI yang dibangun menggunakan bahasa Java. 
Proyek ini menerapkan konsep Object-Oriented Programming (OOP) seperti Inheritance, 
Polymorphism, Encapsulation, dan Abstraction. 

Sistem ini menggunakan File I/O (file .txt) sebagai database sederhana
untuk menyimpan data menu, pegawai, dan customer.
